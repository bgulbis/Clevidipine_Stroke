...
```{r primary_all_median, results='asis'}
ptbl <- print(tbl, printToggle = FALSE, nonnormal = vars)
knitr::kable(ptbl[, 1:3], caption = "All")
```
...
```{r stroke_primary_median, results='asis'}
ptbl <- print(tbl, printToggle = FALSE, nonnormal = vars)
knitr::kable(ptbl[, 1:3], caption = "Stroke")
```
...
```{r ich_primary_median, results='asis'}
ptbl <- print(tbl, printToggle = FALSE, nonnormal = vars)
knitr::kable(ptbl[, 1:3], caption = "ICH")
```
...
sbp_drip %>%
    ...
    geom_point(aes(color = group), alpha = 0.7, size = 0.7) +
    geom_smooth(aes(linetype = group), color = "black") +
    ggtitle("Figure 2. Change in systolic blood pressure from drip initiation") +
